...
import nuxt_plugin_plugin_dae76d14 from 'nuxt_plugin_plugin_dae76d14' // Source: ./components/plugin.js (mode: 'all')
...
import nuxt_plugin_pluginmain_8f12d416 from 'nuxt_plugin_pluginmain_8f12d416' // Source: ./nuxt-i18n/plugin.main.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"titleTemplate":"%s | Colors","title":"COLORS","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"},{"hid":"charset","charset":"utf-8"},{"hid":"mobile-web-app-capable","name":"mobile-web-app-capable","content":"yes"},{"hid":"apple-mobile-web-app-title","name":"apple-mobile-web-app-title","content":"colors"},{"hid":"og:type","name":"og:type","property":"og:type","content":"website"},{"hid":"og:title","name":"og:title","property":"og:title","content":"colors"},{"hid":"og:site_name","name":"og:site_name","property":"og:site_name","content":"colors"},{"hid":"og:description","name":"og:description","property":"og:description","content":"## node version ### v14.17.6"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Frgb.png"},{"rel":"stylesheet","type":"text\u002Fcss","href":"https:\u002F\u002Ffonts.googleapis.com\u002Fcss?family=Roboto:100,300,400,500,700,900&display=swap"},{"rel":"stylesheet","type":"text\u002Fcss","href":"https:\u002F\u002Fcdn.jsdelivr.net\u002Fnpm\u002F@mdi\u002Ffont@latest\u002Fcss\u002Fmaterialdesignicons.min.css"},{"rel":"manifest","href":"\u002F_nuxt\u002Fmanifest.1b725abf.json","hid":"manifest"}],"style":[],"script":[],"htmlAttrs":{"lang":"es"}},
  ...
  if (typeof nuxt_plugin_plugin_dae76d14 === 'function') {
    await nuxt_plugin_plugin_dae76d14(app.context, inject)
  }

  if (typeof nuxt_plugin_plugin_261e5e38 === 'function') {
    await nuxt_plugin_plugin_261e5e38(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_workbox_f81c90b0 === 'function') {
    await nuxt_plugin_workbox_f81c90b0(app.context, inject)
  }

  if (typeof nuxt_plugin_metaplugin_06e6528a === 'function') {
  ...
  if (typeof nuxt_plugin_pluginutils_fb037ba2 === 'function') {
    await nuxt_plugin_pluginutils_fb037ba2(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginrouting_dc12008c === 'function') {
    await nuxt_plugin_pluginrouting_dc12008c(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginmain_8f12d416 === 'function') {
    await nuxt_plugin_pluginmain_8f12d416(app.context, inject)
  }
